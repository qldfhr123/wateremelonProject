...
public class LpopularController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		System.out.println("LrpopularController 테스트");
		Dao = new ChartDAO();
		musicList = Dao.popularAll(); // oracle에서 음악 전체 리스트 가져오기.(정렬은 아직 안함.)
...
//    		mpc.setPDTO(pdto);
		...
		songContainer.getChildren().addAll(heartBox, AlbumCoverBox, songInfo, playBox);
